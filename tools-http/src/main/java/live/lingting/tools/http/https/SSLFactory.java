...
public class SSLFactory extends SSLSocketFactory {
	...
	public SSLFactory(String... protocols) throws NoSuchAlgorithmException, KeyManagementException {
		this(HttpConstants.TLS, DefaultHttps.KEY_MANAGERS, DefaultHttps.TRUST_MANAGERS, new SecureRandom(), protocols);
	}

	public SSLFactory(String protocol, KeyManager[] keyManagers, TrustManager[] trustManagers,
